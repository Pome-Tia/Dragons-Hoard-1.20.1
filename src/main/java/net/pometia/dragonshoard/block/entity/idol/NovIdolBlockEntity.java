...
public class NovIdolBlockEntity extends BlockEntity {
    ...
    public NovIdolBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.NOV_IDOL_BE, pos, state);
    }
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, NovIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
    ...
    public static void serverTick(World world, BlockPos pos, BlockState state, NovIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
        long l = world.getTime();
        List<BlockPos> list = blockEntity.activatingBlocks;
        List<BlockPos> list2 = blockEntity.enhancingBlocks;
    ...
    private static void openEye(NovIdolBlockEntity blockEntity, List<BlockPos> activatingBlocks) {
...
//    private static void attackHostileEntity(World world, BlockPos pos, BlockState state, List<BlockPos> enhancingBlocks, NovIdolBlockEntity blockEntity) {
...
//    }
    ...
    private static void updateTargetEntity(World world, BlockPos pos, NovIdolBlockEntity blockEntity) {
