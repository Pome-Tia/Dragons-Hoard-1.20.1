...
public class DecIdolBlockEntity extends BlockEntity {
    ...
    public DecIdolBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.DEC_IDOL_BE, pos, state);
    }
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, DecIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
    ...
    public static void serverTick(World world, BlockPos pos, BlockState state, DecIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
        long l = world.getTime();
        List<BlockPos> list = blockEntity.activatingBlocks;
        List<BlockPos> list2 = blockEntity.enhancingBlocks;
    ...
    private static void openEye(DecIdolBlockEntity blockEntity, List<BlockPos> activatingBlocks) {
...
//    private static void attackHostileEntity(World world, BlockPos pos, BlockState state, List<BlockPos> enhancingBlocks, DecIdolBlockEntity blockEntity) {
...
//    }
    ...
    private static void updateTargetEntity(World world, BlockPos pos, DecIdolBlockEntity blockEntity) {
