...
public class AprIdolBlockEntity extends BlockEntity {
    ...
    public AprIdolBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.APR_IDOL_BE, pos, state);
    }
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, AprIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
    ...
    public static void serverTick(World world, BlockPos pos, BlockState state, AprIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
        long l = world.getTime();
        List<BlockPos> list = blockEntity.activatingBlocks;
        List<BlockPos> list2 = blockEntity.enhancingBlocks;
    ...
    private static void openEye(AprIdolBlockEntity blockEntity, List<BlockPos> activatingBlocks) {
...
//    private static void attackHostileEntity(World world, BlockPos pos, BlockState state, List<BlockPos> enhancingBlocks, AprIdolBlockEntity blockEntity) {
...
//    }
    ...
    private static void updateTargetEntity(World world, BlockPos pos, AprIdolBlockEntity blockEntity) {
