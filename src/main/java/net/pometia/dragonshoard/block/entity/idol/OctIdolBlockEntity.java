...
public class OctIdolBlockEntity extends BlockEntity {
    ...
    public OctIdolBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.OCT_IDOL_BE, pos, state);
    }
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, OctIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
    ...
    public static void serverTick(World world, BlockPos pos, BlockState state, OctIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
        long l = world.getTime();
        List<BlockPos> list = blockEntity.activatingBlocks;
        List<BlockPos> list2 = blockEntity.enhancingBlocks;
    ...
    private static void openEye(OctIdolBlockEntity blockEntity, List<BlockPos> activatingBlocks) {
...
//    private static void attackHostileEntity(World world, BlockPos pos, BlockState state, List<BlockPos> enhancingBlocks, OctIdolBlockEntity blockEntity) {
...
//    }
    ...
    private static void updateTargetEntity(World world, BlockPos pos, OctIdolBlockEntity blockEntity) {
