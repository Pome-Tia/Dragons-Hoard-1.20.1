...
public class AugIdolBlockEntity extends BlockEntity {
    ...
    public AugIdolBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.AUG_IDOL_BE, pos, state);
    }
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, AugIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
    ...
    public static void serverTick(World world, BlockPos pos, BlockState state, AugIdolBlockEntity blockEntity) {
        blockEntity.ticks++;
        long l = world.getTime();
        List<BlockPos> list = blockEntity.activatingBlocks;
        List<BlockPos> list2 = blockEntity.enhancingBlocks;
    ...
    private static void openEye(AugIdolBlockEntity blockEntity, List<BlockPos> activatingBlocks) {
...
//    private static void attackHostileEntity(World world, BlockPos pos, BlockState state, List<BlockPos> enhancingBlocks, AugIdolBlockEntity blockEntity) {
...
//    }
    ...
    private static void updateTargetEntity(World world, BlockPos pos, AugIdolBlockEntity blockEntity) {
